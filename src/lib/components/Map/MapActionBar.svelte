...
<AppContainer class="h-full flex flex-col items-center gap-5">
	<div class="flex flex-col flex-1 gap-2">
		...
		<div class="border-b border-primary"></div>
		<Button variant="ghost" size="icon" title="Rückgängig machen" on:click={() => dispatch('undo')}>
			<Undo />
		</Button>
		<div class="border-b border-primary"></div>
		<Popover portal={null}>
